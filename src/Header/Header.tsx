...
import { STREAM_PROFILE, STREAM_PREVIEW } from '../utils/streamTools/constants';
import { ValidateAddress } from '../utils/streamTools/WalletAddress'; // global key handling
            ...
            <Box display='flex' flexGrow={1}>
                ...
                >
                    <Typography
                        ...
                        sx={{ml:1,mr:1}}
                    >
                        <img src={MARKET_LOGO} height="40px" width="137px" className="header-logo" alt="Powered by Stream Protocol" />
                    </Typography>
                </Button>
                    <Container
                        component="form"
