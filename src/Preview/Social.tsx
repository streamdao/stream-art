...
export function SocialFlags(props: any){
    ...
    function handleFlagMintTransaction(mint:string){
        ...
        const tokenMintName = 'Stream';
        const to = HQ9xdik6TD9wJHFDxQHoSJ4U9HWGP3xfVXLNDG3m2h7y;
        ...
        :
            <>
                ...
                <BootstrapDialog 
                    ...
                    <DialogActions>
                        <Button component="a" href={`${STREAM_PROFILE}`}>Back</Button>
                        <Button 
