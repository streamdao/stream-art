...
import BN from "../utils/streamTools/node_modules/bn.js.js";
...
import { STREAM_RPC_ENDPOINT, STREAM_RPC_REFRESH, STREAM_PREVIEW, STREAM_PROFILE, STREAM_IDENTITY, FEATURED_DAO_ARRAY } from '../utils/streamTools/constants';
                ...
                return (
                        ...
                        <Grid 
                            ...
                            <Grid item sx={{display:'flex',justifyContent:'center',alignItems:'center'}}>
                                <ListItemButton
                                    component={Link} to={`${STREAM_PREVIEW}${mint}`}
                                    sx={{
                                        width:'100%',
                                        borderRadius:'25px',
                                        p: '2px'
        ...
        return (
            ...
            >
                <ListItem disablePadding>
                    <ListItemButton
                        title={t('Back Home')}
                        component={Link} to={`${STREAM_PROFILE}${publicKey.toBase58()}`}
                        sx={{
                            width:'100%',
                            borderRadius:'25px',
                            p: 1
                        ...
                        >
                            {featuredObj && (
                                <Card sx={{borderRadius:'26px',mb:2}}>
                                        ...
                                        {/*component={Link} to={`${STREAM_PROFILE}${featuredObj.address}`}*/}
                                    <CardActionArea
                                ...
                                <Grid 
                                    ...
                                    <Box
                                        className='stream-profile-background'
                                    >
                                    {featuredObj ? (  
                                        <img
                                            src={featuredObj.img}
                                            alt=""
                                            className="stream-art-profile-img"
                                        />
                                    )
                                    :(
                                        <>
                                                ...
                                                <Grid item>
                                                    <Box sx={{ mt:-1.5,mr:-2 }}>
                                                        ...
                                                        <Typography component="div" variant="caption" alignItems="flex-end" justifyContent="flex-end">
                                                            ...
                                                            <ShareSocialURL url={window.location.href} title={'StreamDAO Profile | '+trimAddress(pubkey,4)} />
...
export function ProfileView(this: any, props: any) {
    ...
    function handlePublicKeySubmit(event: any) {
        ...
        if ((newinputpkvalue && newinputpkvalue.length>0 && ValidateAddress(newinputpkvalue))||
            ...
            navigate({
                pathname: STREAM_PROFILE+newinputpkvalue
            },
                { replace: true }
            );
            setNewInputPKValue('');
    ...
    React.useEffect(() => { 
        if (withPubKey){
            if (ValidateAddress(withPubKey)){
                ...
                navigate({
                    pathname: STREAM_PROFILE+withPubKey
                },
                    { replace: true }
                );
            } else {
            ...
            >
                <Box>  
                        ...
                        <>
                            <React.Fragment>
                                <Box
                                    className="stream-art-generic-placeholder-container"
                                > 
                                        <Grid 
                                            container 
                                            direction="column" 
                                    ...
                                    >
                                        ...
                                        > 
                                            <Typography
                                                ...
                                                display='flex'
                                                sx={{mb:3}}
                                            >{t('Social. Stateless. NFT marketplace.')}</Typography>
